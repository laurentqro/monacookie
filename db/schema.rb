...
ActiveRecord::Schema[8.1].define(version: 2025_10_07_212002) do
  ...
  create_table "consents", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.bigint "account_id", null: false
    t.jsonb "consent_choices", default: {}, null: false
    t.datetime "consent_given_at", null: false
    t.integer "consent_method", null: false
    t.integer "consent_version", default: 1, null: false
    t.datetime "created_at", null: false
    ...
    t.index ["account_id"], name: "index_consents_on_account_id"
    t.index ["consent_choices"], name: "index_consents_on_consent_choices", using: :gin
    t.index ["consent_given_at"], name: "index_consents_on_consent_given_at"
    t.index ["visitor_id"], name: "index_consents_on_visitor_id"
    t.index ["website_id", "consent_given_at"], name: "index_consents_on_website_id_and_consent_given_at"
    t.index ["website_id"], name: "index_consents_on_website_id"
  ...
  create_table "cookies", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "website_id", null: false
    t.index ["category"], name: "index_cookies_on_category"
    t.index ["website_id", "name", "domain"], name: "index_cookies_on_website_id_and_name_and_domain", unique: true
    t.index ["website_id"], name: "index_cookies_on_website_id"
  end
  ...
  create_table "websites", force: :cascade do |t|
    ...
    t.index ["api_key"], name: "index_websites_on_api_key", unique: true
    t.index ["domain"], name: "index_websites_on_domain"
    t.index ["verification_token"], name: "index_websites_on_verification_token", unique: true
  end
  ...
  add_foreign_key "consents", "accounts"
  add_foreign_key "consents", "websites"
  add_foreign_key "cookies", "websites"
